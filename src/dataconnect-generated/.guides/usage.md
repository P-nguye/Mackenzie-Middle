...
```ts
import { useCreateUser, useCreatePost, useListPostsInFandom, useAddComment } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useListPostsInFandom(listPostsInFandomVars);
...
```js
import { createUser, createPost, listPostsInFandom, addComment } from '@dataconnect/generated';
...
// Operation ListPostsInFandom:  For variables, look at type ListPostsInFandomVars in ../index.d.ts
